...
@section('content')
    ...
    <div class="row">
        ...
        <!-- 検索エリア -->
        <form  class="my-2 my-lg-0 ml-2" action="{{route('invoiceserch')}}" method="GET">
            @csrf
            @method('get')
            <style>
                .exright{
    ...
    <div class="container">
        ...
        <form action="{{ route('invoicepostUpload', $customer_id )}}" id="file-upload" method="POST" enctype="multipart/form-data">
            <div id="upload-container" style="border: 1px solid; padding: 30px;">
                @csrf
            {{-- 複数法人 --}}
            <a style="color:blue">送信先: </a>
...
<script type="text/javascript">
    ...
    var r = new Flow({
        ...
        // target: '/uploads',
        target: "{{ route('invoicepostUpload', $customer_id ) }}",
