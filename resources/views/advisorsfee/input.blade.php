    ...
    <table class="table table-responsive text-nowrap table-striped table-borderd table_sticky">
        <thead>
            <tr>
                ...
                <th scope="col" class ="col-xs-3 col-md-2 bg-info text-right">@sortablelink('business_name', '顧客名')</th>
                ...
                <th scope="col" class ="col-xs-3 col-md-1 bg-info text-right">@sortablelink('individual_class','法人/個人')</th>
...
@endphp
                ...
                <th scope="col" class ="fixed02 col-xs-3 col-md-1 bg-secondary text-right">操作</th>
            </tr>
        </thead>
                ...
                <input type="text" class="form-control"  id="fee_12_{{$advisorsfee->id}}" name="fee_12_{{$advisorsfee->id}}" value="{{$str}}">
                    ...
                    <td>
                        <div class="btn-toolbar">
                            ...
                            {{-- <form action="" method="POST" class="bl_form" enctype="multipart/form-data"> --}}
                                {{-- @csrf --}}
                                {{-- <div class="bl_formGroup"> --}}
                                    {{-- <label for="image" class="el_label">画像アップロード</label> --}}
                                    {{-- <input type="file" class="el_form" name="image"> --}}
                                {{-- </div> --}}
                                {{-- <button  class="btn btn-info btn-sm" type="submit">アップロード</button> --}}
                            {{-- </form> --}}
                        </div>
                    </td>
                </tr>
